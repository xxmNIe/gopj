...
func (Person_PhoneType) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_address_proto_enumTypes[0].Descriptor()
}

func (Person_PhoneType) Type() protoreflect.EnumType {
	return &file_proto_address_proto_enumTypes[0]
}
...
func (Person_PhoneType) EnumDescriptor() ([]byte, []int) {
	return file_proto_address_proto_rawDescGZIP(), []int{0, 0}
}
...
type Person struct {
	...
	Phones      []Person_PhoneType     `protobuf:"varint,4,rep,packed,name=phones,proto3,enum=proto.Person_PhoneType" json:"phones,omitempty"`
...
func (x *Person) GetPhones() []Person_PhoneType {
	if x != nil {
		return x.Phones
	}
	return nil
...
var file_proto_address_proto_rawDesc = []byte{
	...
	0x6e, 0x2e, 0x50, 0x68, 0x6f, 0x6e, 0x65, 0x54, 0x79, 0x70, 0x65, 0x52, 0x06, 0x70, 0x68, 0x6f,
	...
	0x6e, 0x52, 0x06, 0x70, 0x65, 0x6f, 0x70, 0x6c, 0x65, 0x42, 0x12, 0x5a, 0x10, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x2d, 0x74, 0x65, 0x73, 0x74, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x06, 0x70,
...
var file_proto_address_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_proto_address_proto_depIdxs = []int32{
	0, // 0: proto.Person.phones:type_name -> proto.Person.PhoneType
...
func file_proto_address_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_proto_address_proto_enumTypes,
